...
export default function ItineraryPage() {
  ...
  const { itinerary, weather, cityImage } = location.state || {}
  ...
  return (
    <div className="min-h-screen bg-gray-50 animate-fade-in">
      ...
      <div className="relative h-64 sm:h-80 flex items-end" style={bgStyle}>
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 pb-6 flex flex-col sm:flex-row items-end sm:items-end justify-between gap-4">
          <div>
        ...
        {cityImage?.photographer && (
          <a
            href={cityImage.photographer_url}
            target="_blank"
